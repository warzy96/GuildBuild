...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`igra` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`ceh` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`dogadaj` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`cilj` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`klasa` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`korisnik` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`lik` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`obrazac` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `guild_build`.`podcilj` ;

CREATE TABLE IF NOT EXISTS `guild_build`.`podcilj` (
  `sifPodcilja` INT(11) NOT NULL AUTO_INCREMENT,
  `nazivPodcilja` VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_general_mysql500_ci' NOT NULL,
